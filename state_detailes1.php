...
if( $result-> num_rows > 0 )
{
    ...
    while($row=$result->fetch_assoc()){
     echo ' <div class="col-3" ><img class="mg_d" src="images/states/'.$row["image_name"].'" alt=""  style=" width: 150px;height: 150px;border-radius: 50%;"></div>';
...
if($result->num_rows>0){
    //brings data
   echo '<div style=" display: block;width: 100%; background:#f7f7f7;margin: 0px; text-align: center;">';
    while($row=$result->fetch_assoc()){
